...
describe('UserService', () => {
  ...
  it('should add user', () => {
    ...
    const req = httpMock.expectOne('http://172.179.48.22:8090/api/users');
  ...
  it('should login', () => {
    ...
    const req = httpMock.expectOne('http://172.179.48.22:8090/api/auth/authenticate');
    expect(req.request.method).toBe('POST');
  ...
  it('should update user', () => {
    ...
    const req = httpMock.expectOne(`http://172.179.48.22:8090/api/users/${id}`);
