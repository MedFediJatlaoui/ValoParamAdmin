...
export class UserService {
  ...
  addUser(dto: any, file: File): Observable<UserDto> {
    ...
    return this.http.post<any>('http://valoparamapi-service:8090/api/users', formData);
  }
  getUserDetails() {
  ...
  updateUser(id: number, registerDto: RegisterDto, file: File): Observable<UserDto> {
    ...
    return this.http.put<UserDto>(`http://valoparamapi-service:8090/api/users/${id}`, formData, { headers: headers })
      .pipe(
